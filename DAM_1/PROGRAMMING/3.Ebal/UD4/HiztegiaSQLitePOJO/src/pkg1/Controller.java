...
public class Controller implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
            ...
            Terminoa hitza = new Terminoa(Integer.parseInt(view.jTextFieldID.getText()), view.jTextFieldEus.getText(), view.jTextFieldEsp.getText());
            switch (actionCommand) {
                  case "TXERTATU":
                        System.out.println("TXERTATU botoia sakatu duzu");
                        model.terminoaGehitu(hitza);
                        break;
                  case "IMPRIMATU":
                   ...
                   case "ALDATU":
                        ...
                        model.terminoaAldatu(hitza);
                        break;
                  case "EZABATU":
                        System.out.println("EZABATU botoia sakatu duzu");
                        model.terminoaEzabatu(hitza);
                        break;
            }
      }
}
