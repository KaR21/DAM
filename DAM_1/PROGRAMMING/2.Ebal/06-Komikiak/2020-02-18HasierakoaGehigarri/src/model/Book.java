...
public class Book implements Argitagarria {
      ...
      public String toString() {
            return name + ", " + author.getName() + ", " + price + ", " + pages + ", " + hizkuntza;
      }
      ...
      public void argitaratu() {
            if (hizkuntza == Hizkuntza.EUS) {
                  System.out.println("Eibarren argitaratua " + LocalDate.now() + " egunean " + hizkuntza + " hizkuntzan.");
            } else {
                  if (hizkuntza == Hizkuntza.ES) {
                        System.out.println("Madriden argitaratua " + LocalDate.now() + " egunean " + hizkuntza + " hizkuntzan.");
                  } else {
                        System.out.println("Espainitik kanpo argitaratua " + LocalDate.now() + " egunean " + hizkuntza + " hizkuntzan.");
                  }
            }
