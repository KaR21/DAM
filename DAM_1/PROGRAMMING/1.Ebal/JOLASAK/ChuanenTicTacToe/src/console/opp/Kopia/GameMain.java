      ...
      public void playerMove(Seed theSeed) {
            ...
            do {
                  if (theSeed == Seed.CROSS) {
                        System.out.print("Player " + x + ", enter your move (row[1-" + Board.ROWS +"] column[1-" + Board.COLS + "]): ");
                  } else {
                        System.out.print("Player " + o + ", enter your move (row[1-" + Board.ROWS + "] column[1-" + Board.COLS + "]): ");
                  }
