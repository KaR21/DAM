package console.non.opp;

import java.util.Scanner;

/**
 * Tic-Tac-Toe: Two-player console, non-graphics, non-OO version. All variables/methods are declared as static (belong to the class) in the non-OO version.
 */
public class TTTConsoleNonOO2P {
      ...
      public static int askToRepit() {
            System.out.println("Do you want to start again? (0 for NO and 1 for YES)");
            return (in.nextInt());
      }
